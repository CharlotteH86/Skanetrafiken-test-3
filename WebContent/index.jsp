...
<title>Skånetrafiken sök hållplats</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				...
				<p class="lead">Sök närmsta station</p>
				<form class="display-4"
					action="<%=request.getContextPath()%>/Controller" method="get">


					City:<input type="text" name="city" /><br /> <input type="submit"
						value="Go">
				</form>
	...
	<script
		src="\bootstrap\vendor\jquery\jquery.min.js"></script>
	<script
